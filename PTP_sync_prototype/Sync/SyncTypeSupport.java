...
public class SyncTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "Sync";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SyncTypeSupport _singleton
    = new SyncTypeSupport();
    ...
    */
    public static SyncTypeSupport get_instance() {
        return _singleton;
    }

    public static SyncTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SyncTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Sync</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Sync typedDst = (Sync) destination;
        Sync typedSrc = (Sync) source;
    ...
    int mask) {
        return new SyncDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SyncDataReader(native_reader, listener, mask, this);   
    ...
    protected SyncTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SyncTypeCode.VALUE,Sync.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SyncTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SyncTypeCode.VALUE,Sync.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
