...
/**
* A sequence of Sync instances.
*/
public final class SyncSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SyncSeq (int initialMaximum) {
        super(Sync.class, initialMaximum);
    }

    public SyncSeq (Collection elements) {
        super(Sync.class, elements);
    }

    public  Sync get(int index) { 
        return (Sync) super.get(index); 
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Sync objects (beyond the original size of this object)
