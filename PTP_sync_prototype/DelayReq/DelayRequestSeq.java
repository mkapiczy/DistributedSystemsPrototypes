...
/**
* A sequence of DelayRequest instances.
*/
public final class DelayRequestSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DelayRequestSeq() {
        super(DelayRequest.class);
    }

    public DelayRequestSeq (int initialMaximum) {
        super(DelayRequest.class, initialMaximum);
    }

    public DelayRequestSeq (Collection elements) {
        super(DelayRequest.class, elements);
    }

    public  DelayRequest get(int index) { 
        return (DelayRequest) super.get(index); 
    }
