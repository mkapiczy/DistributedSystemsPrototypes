...
public class DelayRequestTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DelayRequest";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DelayRequestTypeSupport _singleton
    = new DelayRequestTypeSupport();
    ...
    */
    public static DelayRequestTypeSupport get_instance() {
        return _singleton;
    }

    public static DelayRequestTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DelayRequestTypeCode.VALUE;
    }

    public Object create_data() {
        return DelayRequest.create();
    }
    ...
    * <code>this</code> is not a <code>DelayRequest</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DelayRequest typedDst = (DelayRequest) destination;
        DelayRequest typedSrc = (DelayRequest) source;
        ...
        Object sample) 
    {
        ...
        DelayRequest typedSrc = (DelayRequest) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DelayRequest typedDst = (DelayRequest) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DelayRequest typedDst = (DelayRequest) sample;
    ...
    int mask) {
        return new DelayRequestDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DelayRequestDataReader(native_reader, listener, mask, this);   
    ...
    protected DelayRequestTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DelayRequestTypeCode.VALUE,DelayRequest.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DelayRequestTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DelayRequestTypeCode.VALUE,DelayRequest.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
