...
/**
* A sequence of DelayResponse instances.
*/
public final class DelayResponseSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DelayResponseSeq() {
        super(DelayResponse.class);
    }

    public DelayResponseSeq (int initialMaximum) {
        super(DelayResponse.class, initialMaximum);
    }

    public DelayResponseSeq (Collection elements) {
        super(DelayResponse.class, elements);
    }

    public  DelayResponse get(int index) { 
        return (DelayResponse) super.get(index); 
    }
