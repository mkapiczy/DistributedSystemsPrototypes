...
public class DelayResponseTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DelayResponse";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DelayResponseTypeSupport _singleton
    = new DelayResponseTypeSupport();
    ...
    */
    public static DelayResponseTypeSupport get_instance() {
        return _singleton;
    }

    public static DelayResponseTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DelayResponseTypeCode.VALUE;
    }

    public Object create_data() {
        return DelayResponse.create();
    }
    ...
    * <code>this</code> is not a <code>DelayResponse</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DelayResponse typedDst = (DelayResponse) destination;
        DelayResponse typedSrc = (DelayResponse) source;
        ...
        Object sample) 
    {
        ...
        DelayResponse typedSrc = (DelayResponse) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.msgId);

            dst.writeInt(typedSrc.requestId);

            dst.writeInt(typedSrc.masterTimeStamp);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DelayResponse typedDst = (DelayResponse) dst;
            typedDst.clear();      
            try{
                typedDst.msgId = src.readInt();
                typedDst.requestId = src.readInt();
                typedDst.masterTimeStamp = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DelayResponse typedDst = (DelayResponse) sample;
    ...
    int mask) {
        return new DelayResponseDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DelayResponseDataReader(native_reader, listener, mask, this);   
    ...
    protected DelayResponseTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DelayResponseTypeCode.VALUE,DelayResponse.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DelayResponseTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DelayResponseTypeCode.VALUE,DelayResponse.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
